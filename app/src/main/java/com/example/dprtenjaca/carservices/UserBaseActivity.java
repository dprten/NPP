...
public class UserBaseActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_user_base);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_car_services) {
            Intent usersIntent = new Intent(getApplicationContext(), UserCarServicesCompanyActivity.class);
            usersIntent.putExtra(NAV_MENU_BUNDLE_KEY, 0);
            startActivity(usersIntent);
        } else if(id == R.id.nav_cash_order) {
            Intent usersIntent = new Intent(getApplicationContext(), UserShoppingCartActivity.class);
            usersIntent.putExtra(NAV_MENU_BUNDLE_KEY, 1);
            startActivity(usersIntent);
        } else if(id == R.id.nav_change_data) {
            Intent usersIntent = new Intent(getApplicationContext(), UserChangeDataActivity.class);
            usersIntent.putExtra(NAV_MENU_BUNDLE_KEY, 2);
            startActivity(usersIntent);
        } else if(id == R.id.nav_account_deactivate) {
            Intent usersIntent = new Intent(getApplicationContext(), UserDeactivateAccountActivity.class);
